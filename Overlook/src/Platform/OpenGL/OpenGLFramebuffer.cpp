...
namespace Overlook
{
	...
	namespace Utils
	{
		...
		static bool IsDepthFormat(FramebufferTextureFormat format)
		{
			switch (format)
			{
			case Overlook::FramebufferTextureFormat::DEPTH32F_TEX3D:
			case Overlook::FramebufferTextureFormat::DEPTH24STENCIL8:
				return true;
				break;
			}
	...
	void OpenGLFramebuffer::Invalidate()
	{
		...
		{
			OL_CORE_ASSERT(mColorAttachments.size() <= 4);
	...
	{
		OL_CORE_ASSERT(attachmentIndex < mColorAttachments.size());
