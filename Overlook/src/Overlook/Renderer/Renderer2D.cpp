...
namespace Overlook
{
	...
	void Renderer2D::Init()
	{
		...
		sData.QuadShader = Shader::Create(AssetManager::GetAssetsPath("Shader/Renderer2D_Quad.glsl"));
		sData.CircleShader = Shader::Create(AssetManager::GetAssetsPath("Shader/Renderer2D_Circle.glsl"));
		sData.LineShader = Shader::Create(AssetManager::GetAssetsPath("Shader/Renderer2D_Line.glsl"));
