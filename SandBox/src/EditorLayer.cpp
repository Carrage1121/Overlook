...
namespace Hazel
{
	...
	void EditorLayer::OnAttach()
	{
		// 	HZ_PROFILE_FUNCTION();
		// 
		// 	m_CheckerboardTexture = Texture3D::Create("assets/textures/Checkerboard.png");
	
		mCamera = CreateScope<Camera>(glm::vec3(0.0f, 0.0f, 3.0f), 1280.0f, 720.0f);
	
		mShader.reset(Shader::Create("assets/Shader/model_loading.vert", "assets/Shader/model_loading.frag"));
	
		mModel = CreateRef<Model>(ModelFilePath);
